...
#Read data
compass_dia <- read.csv("C:/Users/yuqingw1/Workfolder/ProcessingData/microbiome_allvariable_806_transformation.csv")
micro_original <- read.csv("C:/Users/yuqingw1/Workfolder/ProcessingData/microbiome_allvariable_806_original.csv")
...
micro_merge <- compass_dia
micro_merge$diabetes2 <- as.character(micro_merge$diabetes2)
...
#micro_merge$diabetes2[micro_merge$diabetes2 %in% c("I don't know", "I prefer not to answer")] <- "missing"
#micro_merge$diabetes2[micro_merge$diabetes2 == ""] <- "missing"

#Create dataset for UMAP
micro_umap <- subset(micro_merge, select = -c(sampleID, diabetes2, smoking_status, bmi, M6,M12,M18,M24, bmi,age,gender))
...
microBeta <- read.csv("C:\\Users\\yuqingw1\\Workfolder\\ProcessingData\\processing_4_microbiome\\microbiome_combine_806row_493col_bray_curtis.csv")
